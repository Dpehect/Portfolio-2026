...
import { getHomeContent } from "../../../content/site";

const point = new Vector3(0.75, 1.35, 6.75);
...
const languages = computed(() => {
  return getHomeContent(locale.value).languages.map((name) => ({ name }));
});
</script>

<template>
  <ProjectedElement :point="point">
    <div ref="wrapperRef" class="box-languages">
      <div class="box-languages-content">
        <div class="box-languages-title">
          <AppearingText
            :text="t('languages')"
            :steps="1"
            :duration="0.35"
        ...
        <div class="box-languages-list">
          <div class="box-languages-list-item" v-for="(lang, index) in languages" :key="lang.name">
            <p class="box-languages-list-item-name">
              <AppearingText
                :text="lang.name"
                :steps="1"
                :duration="0.35"
