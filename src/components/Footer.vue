...
const showAttribution = import.meta.env.VITE_SHOW_ATTRIBUTION !== "false" && footer.attribution.enabled;
const showMusicCredit = footer.musicCredit.enabled && footer.musicCredit.name;
</script>
        ...
        <div v-if="showAttribution" class="footer-credits-built">
          ...
          <Clickable renderAs="div">
            <Link
              ...
              data-cursor="circle-white"
              data-hoversound="hover"
              >{{ footer.attribution.name }}</Link
            >
          </Clickable>
        </div>
        <div v-if="showMusicCredit" class="footer-credits-music">
          <p>
            {{ t("music-produced-by") }}
          </p>
          <Clickable renderAs="div">
            <Link
              :href="footer.musicCredit.url"
              class="footer-link children-unclickable"
              external
              data-cursor="circle-white"
              data-hoversound="hover"
              >{{ footer.musicCredit.name }}</Link
            >
          </Clickable>
        </div>
