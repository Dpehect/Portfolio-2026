...
const contentLanguagesRef = ref<HTMLDivElement | null>(null);
...
const tlLanguagesRef = ref<gsap.core.Timeline | null>(null);
...
watchEffect((onInvalidate) => {
  if (
    ...
    tlLanguagesRef.value &&
    contentLanguagesRef.value &&
    ...
    transitions.about.setup({
      ...
      contentLanguages: contentLanguagesRef.value,
      tlLanguages: tlLanguagesRef.value,
...
<template>
  <div class="about-content">
    ...
    <div ref="contentLanguagesRef" class="about-languages">
      <BoxLanguages @timeline:created="(tl: gsap.core.Timeline) => (tlLanguagesRef = tl)" />
    </div>
